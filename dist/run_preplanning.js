...
// }
const db_ts_1 = require("./rapla-frontend/src/lib/db.js");
const planningEngine_ts_1 = require("./rapla-frontend/src/lib/planningEngine.js");
const excel_absences_ts_1 = require("./rapla-frontend/src/lib/excel_absences.js");
...
if (fs_1.default.existsSync(dbPath)) {
    let dbContent = fs_1.default.readFileSync(dbPath, 'utf-8');
    ...
    if (braceStartIndex !== -1 && braceEndIndex !== -1 && firstPrePlanIndex !== -1) {
        ...
        updatedContent = updatedContent.replace(/const CURRENT_DB_VERSION = \d+;/g, (match) => {
            const version = parseInt(match.match(/\d+/)[0], 10);
            return `const CURRENT_DB_VERSION = ${version + 1};`;
        });
        fs_1.default.writeFileSync(dbPath, updatedContent);
